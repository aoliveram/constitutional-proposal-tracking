...
def process_file(file_path):
    try:
        ...
        for item in data:
            ...
            new_item["timestamp"] = item.get("timestamp", "05-05")
...
if __name__ == '__main__':
    ...
    if len(sys.argv) > 1:
        ...
        target_file = r'C:\Users\vicel\Proyectos\constitutional-proposal-tracking\comision-4\indicaciones-universal-extracted\C4_VOTACION_informe-5-05-05-indicaciones.json'
